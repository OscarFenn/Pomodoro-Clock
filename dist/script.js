function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}const Header = () => React.createElement("center", { className: "title is-1" }, "Pomodoro Clock");



const SetTimer = ({ type, value, handleClick }) =>
React.createElement("div", { className: "SetTimer" },
React.createElement("div", { className: "is-size-4", id: `${type}-label` }, type === 'session' ? 'Session' : 'Break ', " Length"),
React.createElement("div", { className: "SetTimer-controls" },
React.createElement("button", { className: "button", id: `${type}-decrement`, onClick: () => handleClick(false, `${type}Value`) }, "\u2193"),
React.createElement("h1", { id: `${type}-length` }, value),
React.createElement("button", { className: "button", id: `${type}-increment`, onClick: () => handleClick(true, `${type}Value`) }, "\u2191")));
...
React.createElement("h1", { className: "is-size-4", id: "timer-label" }, mode === 'session' ? 'Session' : 'Break'),
...
React.createElement("button", { className: "button", id: "start_stop", onClick: handlePlayPause }, active ? React.createElement("span", null, "\u275A\u275A") : React.createElement("span", null, "\u25BA")),

React.createElement("button", { className: "button", id: "reset", onClick: handleReset }, "\u21BB"));
...
class App extends React.Component {
  ...
  render() {
    return (
      ...
      React.createElement(Controls, { active: this.state.active,
